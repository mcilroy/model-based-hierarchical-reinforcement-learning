...
% the reduction in training trials for model-based approaches is beneficial for certain problems. Such as where an where the cost of a trial outweighs the cost of computational resources. An example would be a robot that must take actions in real time.
